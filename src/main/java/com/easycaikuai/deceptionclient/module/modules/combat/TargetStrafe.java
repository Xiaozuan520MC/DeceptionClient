...
import com.easycaikuai.deceptionclient.module.modules.movement.Fly;
import com.easycaikuai.deceptionclient.module.modules.movement.LongJump;
import com.easycaikuai.deceptionclient.module.modules.movement.Speed;
...
public class TargetStrafe extends Module {
    ...
    private boolean canStrafe() {
        if (this.speedOnly.getValue()) {
            Speed speed = (Speed) Deception.moduleManager.modules.get(Speed.class);
            Fly fly = (Fly) Deception.moduleManager.modules.get(Fly.class);
