...
void disableEagleForActivation() {
    ...
    try {
        if (Deception.moduleManager == null) return;
        Eagle eagle = (Eagle) Deception.moduleManager.getModule("Eagle");
...
int faceFromName(String name) {
    ...
    private final class ModulesApi {
        ...
        boolean getButton(String moduleName, String name) {
            ...
            if (module == null || Deception.propertyManager == null) return false;
            try {
                Property<?> property = Deception.propertyManager.getProperty(module, name);
        ...
        private Module getModule(String moduleName) {
            if (moduleName == null || Deception.moduleManager == null) return null;
            return Deception.moduleManager.getModule(moduleName);
        }
    }
