...
import com.easycaikuai.deceptionclient.module.modules.movement.Blink;
...
public class TickBase extends Module {
    ...
    private boolean isKillAuraActive() {
        Module module = Deception.moduleManager.modules.get(KillAura.class);
        return module != null && module.isEnabled();
    }

    private boolean isBlinkEnabled() {
        Module module = Deception.moduleManager.getModule("Blink");
        return module != null && module.isEnabled();
    }
