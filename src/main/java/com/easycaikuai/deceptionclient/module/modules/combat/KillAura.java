...
import com.easycaikuai.deceptionclient.module.modules.movement.NoSlow;
import com.easycaikuai.deceptionclient.module.modules.player.AutoBlockIn;
import com.easycaikuai.deceptionclient.module.modules.player.AutoHeal;
...
public class KillAura extends Module {
    ...
    private final IntProperty moreAttackDelay = new IntProperty("MoreAttackDelay", 1, 0, 3, () -> this.autoBlock.getValue() == 2 && this.test.getValue());
    public final BooleanProperty noBlinkAttackPackets = new BooleanProperty("NoBlinkAttackPackets", false, () -> this.autoBlock.getValue() == 2);
    ...
    public KillAura() throws AWTException {
        ...
        this.autoBlock = new ModeProperty(
                "AutoBlock", 0, new String[]{"None", "Vanilla", "Hypixel", "Legit", "Fake","Hypixel Test","Hypixel Custom","NCP","Grim","Intave","Watchdog","Watchdog2"}
        );
    ...
    private boolean performAttack(float yaw, float pitch) {
        if (!Deception.playerStateManager.digging && !Deception.playerStateManager.placing) {
            if (this.isPlayerBlocking() && this.autoBlock.getValue() != 1) {
                ...
                Velocity velocity = (Velocity) Deception.moduleManager.getModule(Velocity.class);
    ...
    private boolean canAttack() {
        if (this.inventoryCheck.getValue() && mc.currentScreen instanceof GuiContainer) {
            ...
            if (((IAccessorPlayerControllerMP) mc.playerController).getIsHittingBlock()) {
                ...
                AutoHeal autoHeal = (AutoHeal) Deception.moduleManager.modules.get(AutoHeal.class);
                if (autoHeal.isEnabled() && autoHeal.isSwitching()) {
                    ...
                    if (bedNuker.isEnabled() && bedNuker.isReady()) {
                        return false;
                    } else if (Deception.moduleManager.modules.get(Scaffold.class).isEnabled()) {
                        return false;
    ...
    public boolean shouldAutoBlock() {
        if (this.isPlayerBlocking() && this.isBlocking) {
            return !mc.thePlayer.isInWater() && !mc.thePlayer.isInLava() && (this.autoBlock.getValue() == 2 || this.autoBlock.getValue() == 3 || this.autoBlock.getValue() == 5 || this.autoBlock.getValue() == 6 || this.autoBlock.getValue() == 7 || this.autoBlock.getValue() == 8 || this.autoBlock.getValue() == 9 || this.autoBlock.getValue() == 10 || this.autoBlock.getValue() == 11);
        } else {
            return false;
        }
    }
                    ...
                    switch (this.autoBlock.getValue()) {
                        case 0:
                            if (PlayerUtil.isUsingItem()) {
                                ...
                                if (!this.isPlayerBlocking() && !Deception.playerStateManager.digging && !Deception.playerStateManager.placing) {
                                    swap = true;
                                }
                            } else {
                                this.isBlocking = false;
                        ...
                        case 4:
                            ...
                            if (PlayerUtil.isUsingItem()
                                    ...
                                    && !Deception.playerStateManager.digging
                                    && !Deception.playerStateManager.placing) {
                                swap = true;
                            }
                            break;
                        case 5:
                ...
                if (this.isBoxInSwingRange(this.target.getBox())) {
                    if (this.rotations.getValue() == 2 || this.rotations.getValue() == 3) {
                        ...
                        if (this.rotations.getValue() == 3) {
                            Deception.rotationManager.setRotation(rotations[0], rotations[1], 1, true);
                        }
    ...
    private void renderScan(Render3DEvent event) {
        ...
        Color centerCol = ((HUD) Deception.moduleManager.modules.get(HUD.class)).getColor(0);
        ...
        for(int i = 0; i <= 360; i+=10) {
            ...
            Color edgeCol = ((HUD) Deception.moduleManager.modules.get(HUD.class)).getColor(i * 10);
        ...
        for (int i = 0; i <= 360; i+=5) {
            double angle = Math.toRadians(i);
            Color lineCol = ((HUD) Deception.moduleManager.modules.get(HUD.class)).getColor(i * 20);
    ...
    public void onDisabled() {
        Deception.blinkManager.setBlinkState(false, BlinkModules.AUTO_BLOCK);
        Velocity.extraAttacked = false;
        if ((this.autoBlock.getValue() == 2 || this.autoBlock.getValue() == 5 || this.autoBlock.getValue() == 6) && Deception.moduleManager.getModule(NoSlow.class).isEnabled()){
            int randomSlot = new Random().nextInt(9);
            while (randomSlot == mc.thePlayer.inventory.currentItem) {
                randomSlot = new Random().nextInt(9);
            }
