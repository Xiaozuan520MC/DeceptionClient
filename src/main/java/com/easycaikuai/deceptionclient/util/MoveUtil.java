...
import com.easycaikuai.deceptionclient.module.modules.combat.TargetStrafe;
...
public class MoveUtil {
    ...
    public static float adjustYaw(float yaw, float forward, float strafe) {
        TargetStrafe targetStrafe = (TargetStrafe) Deception.moduleManager.modules.get(TargetStrafe.class);
