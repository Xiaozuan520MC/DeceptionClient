...
public enum Easing {
    ...
    EASE_OUT_CUBIC(x -> (x = x - 1.0) * x * x + 1.0),
    EASE_IN_OUT_CUBIC(x -> (x < 0.5) ? 4.0 * x * x * x : (x - 1.0) * (2.0 * x - 2.0) * (2.0 * x - 2.0) + 1.0),
    EASE_IN_QUART(x -> x * x * x * x),
    EASE_OUT_QUART(x -> 1.0 - (x = x - 1.0) * x * x * x),
    EASE_IN_OUT_QUART(x -> (x < 0.5) ? 8.0 * x * x * x * x : 1.0 - 8.0 * (x = x - 1.0) * x * x * x),
    EASE_IN_QUINT(x -> x * x * x * x * x),
    EASE_OUT_QUINT(x -> 1.0 + (x = x - 1.0) * x * x * x * x),
    EASE_IN_OUT_QUINT(x -> (x < 0.5) ? 16.0 * x * x * x * x * x : 1.0 + 16.0 * (x = x - 1.0) * x * x * x * x),
    ...
    EASE_OUT_CIRC(x -> Math.sqrt(1.0 - (x = x - 1.0) * x)),
